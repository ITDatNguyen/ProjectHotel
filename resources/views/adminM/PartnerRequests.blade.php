              ...
              @foreach ($Proposals as $Proposal)
                <tr>
                  ...
                  <td>{{$Proposal->Vision}}</td>
                      <td><a class="btn btn-success pull-right" href="/proposal/{{$Proposal->id}}/accept">Chấp nhận</a></td>
                      <td><a class="btn btn-danger pull-right" href="/proposal/{{$Proposal->id}}/decline">Từ chối</a></td>
                </tr>
              @endforeach
         </tbody>
     </table>
