        ...
        <div class="container" style="margin: 0 auto; margin-top: 25px; width: 90%; clear: both">
            <div class="row">
                ...
                <div class="col-xs-4 col-sm-4 col-md-4">
                    ...
                    <p>...On the YOY platform, guests can do on-demand booking without waiting for a reply from a host, and
                        they can check in and out instantaneously instead of waiting at a reservation desk...
                    </p>
                </div>
                <div class="col-xs-4 col-sm-4 col-md-4">
