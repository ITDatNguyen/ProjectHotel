...
<header>
    <div class="container-fluid">
        <div id="left-header">
        <a href="{{url('/home')}}" target="_self" title="Về trang chủ">
                <img class="animated bounce" src="../img/img/logo.png" width="110px" height="64px"/> <span href={{url('/home')}}>Mạng đặt phòng khách sạn Online</span>
            </a>
        </div>
        <div id="right-header">
                        ...
                        @else
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-content">
                                        <div style="border-bottom: 1px solid #e74c3c">
                                            <a href="{{ url('/logout') }}"
