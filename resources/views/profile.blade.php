    ...
    <div class="col-md-8 col-md-offset-2" style="margin-top: 9px">
        <div class="panel panel-default" style="border-top-color: #e74c3c;">
            ...
            <div class="panel-body">
                <img src="{{URL::asset('upload/'.$proposal->ImagePath)}}" width="100%" height="100%" alt="" srcset="">
                <h3 style="text-align: center"> {{$proposal->CompanyName}}</h3>
                <p> Email khách sạn : {{$proposal->CompanyEmail}}</p>
                <p> Địa chỉ : {{$proposal->HQAddress}}</p>
                <p> Mô tả : {{$proposal->Vision}}</p>
                <p> Số điện thoại : {{$proposal->phone_number}}</p>
            </div>
        </div>
    </div>
</div>
